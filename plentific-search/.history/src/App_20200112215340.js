    ...
    axios
      ...
      .then(jsonResponse => {
        if (jsonResponse.data.response.pros) {
          ...
          setPagination(jsonResponse.headers['x-pagination-count']);
          console.log(pagination)
          console.log('header',jsonResponse.headers['x-pagination-count']);
          dispatch({
          ...
          dispatch({
            type: "PAGINATION_SET",
            pagination: jsonResponse.headers['x-pagination-count']
          });
